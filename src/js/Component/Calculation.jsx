    ...
    <>
      <div id="scroll-bar-none" style={{ height: "80vh", overflowY: "scroll" }}>
        ...
        <div className="calculations">
                ...
                return (
                  <div className="col-6">
                    <div className="form-group">
                      <label htmlFor={p + "a11"}>
                        {p}/{lang_var["meters"][selected_language]}
                      </label>
                      <input
                        type="text"
                        name={p}
          ...
          <div>
            <p>
              <b>{lang_var["decking"][selected_language].split(":")[0]}: </b>
              <b>{no_of_planks}</b> pcs of boards are required to cover{" "}
              <b>{result}</b> square meters area
            </p>
            <p>
              <b>{lang_var["joist"][selected_language].split(":")[0]}: </b>
              {/* <b>Joict: </b> */}
            ...
            {fixing_kit_measure == result ? (
              ...
              <p>
                <b>
                  {lang_var["fixingkit"][selected_language].split(":")[0]}:{" "}
                </b>
