...
import multi_lang from '../../multilanguage'
...
const Main = props => {
  ...
  const pannels = [
    {
      id: "1a",
      name: multi_lang.enviroment[props.selected_language],
      component: (
        <EnvironmentSelecter
    ...
    {
      id: "1a",
      name: multi_lang.texture[props.selected_language],
      component: (
        <Textures
    ...
    {
      id: "1a",
      name: multi_lang.material_estimate[props.selected_language],
      component: (
        <Calculation
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-4 p-0 tab-container">
            <Tabs tabs={pannels}  selected_language={props.selected_language}/>
          </div>
        </div>
      </div>
    </>
