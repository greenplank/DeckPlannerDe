...
import multi_language from '../../multilanguage'
    ...
    <>
      <div className="pannel-container p-0">
        <div className="custTabNav">
          {cat_list.map((cato) => {
            console.log(multi_language[cato])
            return (
              <button
                key={cato}
              ...
              >
                {/* {cato} */}
                {multi_language[cato][props.selected_language]}
              </button>
            );
          })}
        </div>
              ...
              >
                {textures.map((texture) => (
                  ...
                  >
                    ...
                    >
                      {texture.multi_language[props.selected_language]}
                    </p>
                  </div>
                ))}
              </div>
        ...
        <div className="mt-5">
          ...
          <div className="row">
            <div className="col-md-4">
              <p>{props.selected_board.desc}</p>
              <b>Dimensions in mm: </b>
              <br /> length = {props.selected_board.size.l} <br />
              width = {props.selected_board.size.w} <br /> thickness ={" "}
              {props.selected_board.size.t}
            </div>
            <div className="col-md-8">
              <img
              style={{width:"100%"}}
                src={`/images/typeimage/${props.selected_board.typeimage}`}
                alt=""
              />
            </div>
          </div>
